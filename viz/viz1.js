export function drawMedalsVsGdpGraph({ containerSelector, dataByYear, defaultYear }) {
    ...
    const continentColors = {
        Europe: "#1f77b4", Asie: "#ff7f0e", Afrique: "#2ca02c",
        Océanie: "#17becf", Amérique: "#d62728"
    };

    const countryContinentMap = {
        USA: "Amérique", CHN: "Asie", JPN: "Asie", AUS: "Océanie",
        FRA: "Europe", GBR: "Europe", KOR: "Asie", ITA: "Europe",
        NZL: "Océanie", CAN: "Amérique", UZB: "Asie", HUN: "Europe",
        ESP: "Europe", SWE: "Europe", KEN: "Afrique", NOR: "Europe",
        IRL: "Europe", BRA: "Amérique", UKR: "Europe", ROU: "Europe",
        GEO: "Europe", BEL: "Europe", SRB: "Europe", CZE: "Europe",
        AZE: "Asie", BRN: "Asie", AUT: "Europe", HKG: "Asie",
        ISR: "Asie", POL: "Europe", KAZ: "Asie", JAM: "Amérique",
        THA: "Asie", ETH: "Afrique", ECU: "Amérique", ARG: "Amérique",
        EGY: "Afrique", TUN: "Afrique", CHI: "Amérique", LCA: "Amérique",
        UGA: "Afrique", DOM: "Amérique", MAR: "Afrique", DMA: "Amérique",
        PAK: "Asie", TUR: "Europe", MEX: "Amérique", ARM: "Asie",
        COL: "Amérique", KGZ: "Asie", LTU: "Europe", IND: "Asie",
        MDA: "Europe", CYP: "Europe", JOR: "Asie", PAN: "Amérique",
        TJK: "Asie", ALB: "Europe", CPV: "Afrique", CIV: "Afrique",
        PER: "Amérique", QAT: "Asie", SGP: "Asie", SVK: "Europe",
        FIN: "Europe", BLR: "Europe", EST: "Europe", SMR: "Europe",
        MKD: "Europe", TKM: "Asie", SYR: "Asie", GHA: "Afrique",
        CUB: "Amérique", LIE: "Europe", LAT: "Europe", RUS: "Europe",
        DEU: "Europe", NED: "Europe", NLD: "Europe", CHE: "Europe",
        POR: "Europe", SVN: "Europe"
    };
    ...
    if (!allData.length) {
        console.warn("No overall data available in dataByYear.");
        return;
    }
    ...
    Object.entries(dataByYear).forEach(([year, yearData]) => {
        const maxMedals = d3.max(yearData, d => d.total) || 10;
    ...
    function updateGraphForRange(mode, minYear, maxYear) {
        ...
        aggregatedData = aggregatedData.filter(d => d.population > 0 && d.gdp > 0);
        if (aggregatedData.length === 0) {
            console.warn("No aggregated data available for the selected year range:", minYear, maxYear);
        ...
        const aggregatedByCountry = Array.from(
            d3.rollup(
                aggregatedData,
                records => {
                    let lastValid = [...records].reverse().find(r => r.gdp > 0 && r.population > 0);
                    if (!lastValid) {
                        lastValid = records[0];
                    }
                    return {
                        ...
                        gdp: lastValid.gdp,
                        population: lastValid.population
                    };
                },
                d => d.countryCode
            ),
